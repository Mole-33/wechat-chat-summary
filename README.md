...
版本更新记录请查看 [Changelog.txt](Changelog.txt)。
...
.\.venv\Scripts\python.exe tools\build_update_manifest.py `
  --asset "dist\WeChatAISummary-v1.0-windows-x64.zip" `
  --url "https://github.com/Mole-33/wechat-chat-summary/releases/download/v1.0/WeChatAISummary-v1.0-windows-x64.zip" `
  --version "1.0" --adapter-version "wechat4-1.2.2.3" `
